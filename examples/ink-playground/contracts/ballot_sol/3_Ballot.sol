...
contract Ballot {
    ...
    function number(int48 value) public pure returns (int48 _value) {
        _value = value;
    }
    ...
    function numbers(
        int48 numeric,
        int56 big
    ) public pure returns (int48 _numeric, int56 _big) {
        _numeric = numeric;
        _big = big;
    }

    function fn_as_arg(function(bool) external pure someFn) public pure {}

    function str_fn_memory(string memory str) public pure {}

    function str_fn_calldata(string calldata str) public pure {}
}
