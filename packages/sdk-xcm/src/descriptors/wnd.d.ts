...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<Iepk3927t67cg5>, false, never>;
        /**
...
type ICalls = {
    ...
    Utility: {
         ...
         *event is deposited.
         */
        batch: TxDescriptor<Anonymize<I7h2u1mc3rf98r>>;
        /**
         ...
         *The dispatch origin for this call must be _Signed_.
         */
        as_derivative: TxDescriptor<Anonymize<I3e5ofpe7ic72u>>;
        /**
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I7h2u1mc3rf98r>>;
        /**
         ...
         *- O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I57oe19187g89v>>;
        /**
         *Send a batch of dispatch calls.
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I7h2u1mc3rf98r>>;
        /**
         ...
         *The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I4l97ms6f1qgl6>>;
    };
    Identity: {
        /**
    ...
    Recovery: {
         ...
         */
        as_recovered: TxDescriptor<Anonymize<I6e4d81al6tnhg>>;
        /**
    ...
    Scheduler: {
         ...
         */
        schedule: TxDescriptor<Anonymize<If1l350tvru1r4>>;
        /**
         ...
         */
        schedule_named: TxDescriptor<Anonymize<I2ruhehjg9j6u2>>;
        /**
         ...
         */
        schedule_after: TxDescriptor<Anonymize<I9bk14f0cb43o5>>;
        /**
         *Schedule a named task after a delay.
         */
        schedule_named_after: TxDescriptor<Anonymize<I4rb2eiv6hsa8>>;
        /**
    ...
    Sudo: {
         ...
         */
        sudo: TxDescriptor<Anonymize<I2q6qeu5f68lv7>>;
        /**
         *Authenticates the sudo key and dispatches a function call with `Root` origin.
         *This function does not check the weight of the call, and instead allows the
         ...
         *The dispatch origin for this call must be _Signed_.
         */
        sudo_unchecked_weight: TxDescriptor<Anonymize<I4l97ms6f1qgl6>>;
        /**
         ...
         *The dispatch origin for this call must be _Signed_.
         */
        sudo_as: TxDescriptor<Anonymize<I3s57f59vuatsu>>;
        /**
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I159emgr7c762d>>;
        /**
         ...
         *- `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I9um7nj6kvsnrg>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<Ier61p6akem2ub>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I9qpqmgcjn9lcv>>;
        /**
         *Register approval for a dispatch to be made from a deterministic composite account if
         *approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Whitelist: {
         ...
         */
        dispatch_whitelisted_call_with_preimage: TxDescriptor<Anonymize<I2q6qeu5f68lv7>>;
    };
    Treasury: {
        /**
    ...
    ParasSudoWrapper: {
         ...
         */
        sudo_queue_downward_xcm: TxDescriptor<Anonymize<Idkd1bprhtg83o>>;
        /**
...
type IRuntimeCalls = {
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I2o87kbhjpov7u>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I2o87kbhjpov7u>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<Icgo40grj87fvv>, call: Anonymize<I2o87kbhjpov7u>], Anonymize<Io5enofhuqai4>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: Anonymize<Ichgaqm88qcdbe>, xcm: Anonymize<Idi8en2lkuicdt>], Anonymize<Iadfiaaiof9d12>>;
    };
    /**
...
export type WndCallData = Anonymize<I2o87kbhjpov7u> & {
    value: {
        type: string;
    };
};
